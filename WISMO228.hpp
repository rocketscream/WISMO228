...
WISMO228<SerialPort>::WISMO228(SerialPort& serial, unsigned char onOffPin)
	: uart(serial)
{
...
*******************************************************************************/
template<class SerialPort>
status_t	WISMO228<SerialPort>::getStatus()
{
	return (status);
}
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::powerUp()
{
	bool	success = false;
...
*******************************************************************************/
template<class SerialPort>
void	WISMO228<SerialPort>::shutdown()
{
	if (status == ON)
	{
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::simReady()
{
	bool	success = false;
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::offEcho()
{
	bool	success = false;
	unsigned long	timeout;
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::registerNetwork()
{
	bool	success = false;
	unsigned long	timeout;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::textModeSms()
{
	bool	success = false;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::newSmsSetup()
{
	bool	success = false;
	...
	if (uart.find(responseBuffer))
	{
      ...
      if (_ringPin == 2)
      {
        // Attach interrupt for RING pin as new SMS indicator
		    attachInterrupt(1, functionPtr, FALLING); 
      }
      else
      {
        // Attach interrupt for RING pin as new SMS indicator
		    attachInterrupt(0, functionPtr, FALLING); 
      }
...
*******************************************************************************/		
template<class SerialPort>
bool	WISMO228<SerialPort>::sendSms(const char *recipient, const char *message)
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::readSms(char *sender, char *message)
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::openGPRS(const char *apn, const char *username,
												const char *password)
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::closeGPRS()
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
unsigned int	WISMO228<SerialPort>::ping(const char	*url)
{	
	// Ping response time
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::getHttp(const char *server, const char *path, const char	*port,
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::putHttp(const char *server, const char *path, const char *port,
...
*******************************************************************************/	
template<class SerialPort>
bool WISMO228<SerialPort>::sendEmail(const char *smtpServer, const char *port,
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::getClock(char *clock)
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
bool WISMO228<SerialPort>::setClock(const char *clock)
{
	bool success = false;
...
*******************************************************************************/
template<class SerialPort>
int	WISMO228<SerialPort>::getRssi()
{
	int rssi;
	char	rxByte;
...
*******************************************************************************/
template<class SerialPort>
int	WISMO228<SerialPort>::rssiToDbm(int	rssi)
{
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::waitForReply(unsigned char count, long period)
{
	bool	success = false;
	unsigned long	timeout;
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::openPort(const char	*server, const char *port)
{
	bool	success = false;
	unsigned	char	attempt;
...
*******************************************************************************/
template<class SerialPort>
bool	WISMO228<SerialPort>::exchangeData()
{
	bool	success = false;
...
*******************************************************************************/
template<class SerialPort>
void	WISMO228<SerialPort>::encodeBase64(const char *input, char *output)
{
	unsigned	int	length;
	char	raw[3];
	char	encoded[4];
...
*******************************************************************************/
template<class SerialPort>
void WISMO228<SerialPort>::readFlash(const char *sourcePtr, char *targetPtr)
{
