...
void setup()  
{
  ...
  if (wismo.powerUp())
  {
    ...
    if (wismo.openGPRS(apn, username, password))
    {
      ...
      if (wismo.getHttp("www.xetroc.com", "/getData.php?name=Dean&countryCode=GB" , "80", message, 50))
      {
        Serial.println("Webpage retrieved:");
        Serial.println(message);
        Serial.println("Go and check www.xetroc.com/get.php to see the result!");
      }
      else
      {
